...
public class TesteFeedForward {
   public static void main(String[] args){
      ...
      rede.camadas[0].configurarPesos(0, pN1);
      rede.camadas[0].configurarBias(0, bN1);
      rede.camadas[0].configurarPesos(1, pN2);
      rede.camadas[0].configurarBias(1, bN2);

      rede.camadas[1].configurarPesos(0, pN3);
      rede.camadas[1].configurarBias(0, bN3);
