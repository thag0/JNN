...
/**
 * Interface de funcionalidades da biblioteca.
 */
public final class JNN {
     ...
     */
    private static Dicionario dicio = new Dicionario();
     ...
     */
    public static Tensor tensor(Object arr) {
     ...
     */
    public static Tensor identidade(int n) {
        if (n < 1) {
    ...
    public static Tensor rand(int... shape) {
        return new Tensor(shape).aplicar(x -> JNNutils.randFloat(-1, 1));
    }
     ...
     * @return {@code Tensor} aleatório.
     */
    public static Tensor rand(RandomGenerator gen, int... shape) {
        Tensor t = new Tensor(shape);

        if (gen == null) {
            t.aplicar(x -> JNNutils.randFloat(-1, 1));
        
        } else {
            t.aplicar(x -> gen.nextFloat(-1, 1));
        }
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor pow(Tensor t, Number exp) {
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor media(Tensor t) {
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor desvp(Tensor t) {
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor corr2D(Tensor a, Tensor b) {
        return ops.corr2D(a, b);
    }
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor atan(Tensor t) {
     ...
     * @return {@code Tensor} resultado.
     */
    public static Tensor tan(Tensor t) {
     ...
     */
    public static Tensor mse(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor mae(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor msle(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor rmse(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor crossEntropy(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor binaryCrossEntropy(Tensor prev, Tensor real) {
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor acuracia(Tensor prev, Tensor real) { 
        return acuracia(
            new Tensor[]{ prev }, 
            new Tensor[]{ real }
        );
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor f1Score(Tensor prev, Tensor real) {
        return f1Score(
            new Tensor[]{ prev }, 
            new Tensor[]{ real }
        );
     ...
     * @return {@code Tensor} contendo o resultado.
     */
    public static Tensor matrizConfusao(Tensor prev, Tensor real) {
     ...
     */
    public static Otimizador getOtimizador(String otm) {
        return dicio.getOtimizador(otm);
    }
     ...
     */
    public static Perda getPerda(String loss) {
        return dicio.getPerda(loss);
    }
     ...
     */
    public static Inicializador getInicializador(String ini) {
        return dicio.getInicializador(ini);
    }
     ...
     */
    public static Tensor[] arrayParaTensores(float[] arr) {
     ...
     */
    public static Tensor norm(Tensor t, Number min, Number max) {
     ...
     * @see jnn.dataloader.DataLoader DataLoader
     */
    public static DataLoader dataloader(Tensor[] x, Tensor[] y) {
     ...
     * @see jnn.dataloader.DataLoader DataLoader
     */
    public static DataLoader dataloader(Amostra[] as) {
     ...
     * @see jnn.dataloader.DataLoader DataLoader
     */
    public static DataLoader dataloader(Amostra a) {
     ...
     * @see jnn.dataloader.DataLoader DataLoader
     */
    public static DataLoader dataloader(float[][] arr, int in, int out) {
